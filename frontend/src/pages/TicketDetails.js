                        ...
                        <div className="max-w-[1000px] mx-auto px-6">
                            <div className="flex flex-col md:flex-row justify-between items-start gap-8">
                                <div>
                                    ...
                                    <h1 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tight mb-1 uppercase">
                                        {ticket.resourceName}
                                    </h1>
                    ...
                    <div className="max-w-[1000px] mx-auto px-6 py-6">
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                ...
                                <section className="bg-white p-6 rounded border border-slate-200 shadow-sm space-y-6">
                                    ...
                                    <form onSubmit={submitComment} className="relative pt-6 border-t border-slate-100">
                                        <textarea
                                            ...
                                            className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded focus:bg-white focus:outline-none focus:ring-1 focus:ring-[#0F172A] font-bold text-slate-800 shadow-sm resize-none min-h-[80px] placeholder:text-slate-400 text-sm"
                            ...
                            <div className="lg:col-span-1 space-y-8">
                                <div className="bg-[#0F172A] p-6 rounded border border-slate-800 text-white shadow-lg relative overflow-hidden">
                                    <div className="absolute top-0 right-0 w-32 h-32 bg-[#FFD166]/10 rounded-full blur-2xl -translate-y-1/2 translate-x-1/2"></div>
                                    <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-4 relative z-10">Metadata Summary</h4>
