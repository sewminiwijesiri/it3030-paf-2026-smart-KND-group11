                    ...
                    <div className="bg-white border-b border-slate-200 py-10">
                        <div className="max-w-[1000px] mx-auto px-6">
                            ...
                            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                                ...
                                <Link to="/report-incident" className="shrink-0 bg-[#FFD166] text-slate-900 px-8 py-3 rounded-full font-black text-[11px] uppercase tracking-widest hover:scale-105 hover:bg-[#FFCC29] transition-all shadow-lg shadow-[#FFD166]/20">
                                    Create New Ticket
                                </Link>
                            </div>
                        </div>
